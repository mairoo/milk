...
export default function ProductCard({
    ...
    return (
        <Card className="w-full max-w-sm cursor-pointer p-0 gap-2 shadow-none hover:shadow-xl transition-shadow" onClick={handleCardClick}>
            {/* 이미지 섹션 */}
            ...
            <CardFooter className="p-2">
                <Button
                    className="w-full flex items-center gap-2 bg-sky-200 text-black hover:bg-sky-600 hover:text-white cursor-pointer"
